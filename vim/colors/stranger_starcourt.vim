...
let g:colors_name = 'stranger_starcourt'
...
let s:bg        = ['#1A1A2E', 235]
let s:fg        = ['#EAEAEA', 253]
let s:selection = ['#2E2E4A', 239]
let s:comment   = ['#6B5B95', 244]
let s:cyan      = ['#00CED1', 117]
let s:green     = ['#00FA9A', 114]
let s:orange    = ['#FFB347', 215]
let s:pink      = ['#FF1493', 212]
let s:purple    = ['#BA55D3', 141]
let s:red       = ['#FF6B6B', 203]
let s:yellow    = ['#FFD700', 228]

let s:bglight   = ['#2E2E42', 236]
let s:bglighter = ['#424256', 237]
