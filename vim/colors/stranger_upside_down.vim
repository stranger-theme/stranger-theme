...
let g:colors_name = 'stranger_upside_down'
...
let s:bg        = ['#0D1117', 235]
let s:fg        = ['#F8F8F2', 253]
let s:selection = ['#2A3C4A', 239]
let s:comment   = ['#5C6370', 244]
let s:cyan      = ['#56B6C2', 117]
let s:green     = ['#98C379', 114]
let s:orange    = ['#D19A66', 215]
let s:pink      = ['#C678DD', 212]
let s:purple    = ['#61AFEF', 141]
let s:red       = ['#E06C75', 203]
let s:yellow    = ['#E5C07B', 228]

let s:bglight   = ['#21252B', 236]
let s:bglighter = ['#35393F', 237]
